...
const char* ssid = "iq1bp-wl";              // WiFi SSID
const char* password = "dciarisez";		// WiFi Password
...
#define METEO_CALLSIGN "IW1CGW-3"
#define METEO_BEACON 10
#define METEO_LAT "4423.28N"
#define METEO_LON "00748.87E"
...
#define LoRa_Frequency 868200E3                    // Frequency (433775000 Hz)
#define LoRa_TxPower 10                            // TX power (max 20 dBm)
