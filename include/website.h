...
#define webPageFooter "<br><br><br><footer><a href='/'>view main meteo page</a> <br> <a href=\"/graphs\">weather charts</a> <br> <a href=\"/lora\">view dashboard</a><br><br>by <a href=\"https://iw1cgw.wordpress.com\">IW1CGW</a> based on <a href=\"https://www.ok2dds.cz\">OK2DDS</a> 'project</footer>"
...
#define web_ChangePrompt_blacklist "<script>window.location.href = '/new-value/' + prompt('station temporarily blacklisted | ex: IZ1XYZ', null);</script>"
